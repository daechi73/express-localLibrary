...
exports.index = asyncHandler(async (req, res, next) => {
  ...
  const [
    ...
    //the handler is paused until all the queries are returned.
  ...
  // once all the queries are returned, the handler continues.
  res.render("index", {
...
exports.book_delete_post = asyncHandler(async (req, res, next) => {
  ...
  if (allBookInstances.length > 0) {
    ...
    await Book.fildByIdAndRemove(req.body.bookid);
    res.redirect("/catalog/books");
  }
});
